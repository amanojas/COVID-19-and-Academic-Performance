...
format:
  pdf:
    ...
    include-in-header: |
      ...
      % fallback if \makecell call lost its backslash
...
f12 <- read_rds(sum_stats_url) |>
  ...
  rename(Correct = avgcor, Score = score)
...
datasummary_balance(
  ...
  fmt = 3,
  stars = TRUE,
  output = "latex",        # request LaTeX
  file = "table_descriptives.tex", # writes to file in working dir
  overwrite = TRUE
)
```
...
results_base <- panelsummary(
  ...
  caption = "Baseline estimates of the effect of COVID-19 on students' academic performance",
  stars = "econ"
)
...
results_gpa <- panelsummary(
  ...
  gof_map = c("nobs", "r.squared"),
  caption = "Differential effect of COVID-19 across GPA quartiles",
  stars = "econ"
)
...
results_did <- panelsummary_raw(
  ...
  clean_raw(
    caption = "Interaction effects of COVID-19 on students’ academic performance"
  )
...
results_did |>
  ...
  pack_rows("Panel B: Online vs Hybrid", 12, 20, bold = T, italic = T) |>
