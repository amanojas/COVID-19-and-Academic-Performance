...
invisible(names(tab_df)) # check exact column name for Std.Dev (e.g. "Std. Dev." or "Std.Dev")
...
results_did |>
  ...
  pack_rows("Panel A: Low GPA vs High GPA", 1, 9, bold = T, italic = T) |>
  pack_rows("Panel B: Online vs Hybrid", 10, 18, bold = T, italic = T) |>
