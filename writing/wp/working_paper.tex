...
Table 3.1 outlines the sample characteristics before and after the
...
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{15em}cccc}
\toprule
\multicolumn{1}{c}{\em{\textbf{ }}} & \multicolumn{2}{c}{\em{\textbf{Easy Questions}}} & \multicolumn{2}{c}{\em{\textbf{Hard Questions}}} \\
\cmidrule(l{3pt}r{3pt}){2-3} \cmidrule(l{3pt}r{3pt}){4-5}
  & (1) & (2) & (3) & (4)\\
\midrule
\addlinespace[0.3em]
...
\hspace{1em}Mean of Dependent Variable & 0.645 & 0.645 & 0.573 & \vphantom{1} 0.573\\
...
\hspace{1em}Mean of Dependent Variable & 0.645 & 0.645 & 0.573 & 0.573\\
