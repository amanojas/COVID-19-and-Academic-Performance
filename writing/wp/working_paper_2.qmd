...
Early work on the effects of COVID-19 on undergraduates relied primarily on survey evidence about students’ experiences rather than direct measures of learning. The Global COVID-19 Student Survey documented substantial disruptions to university students’ academic, financial, and personal lives across 28 institutions in the United States, Europe, Australia, and Mexico, with particularly severe consequences for disadvantaged groups [@jaeger_global_2021]. In a widely cited U.S. study, @aucejo_impact_2020 surveyed roughly 1,500 students at a large public university and found sizable negative effects of the pandemic on academic plans and expectations: 13% of students reported delaying graduation, 40% lost a job, internship, or offer, and 29% anticipated lower earnings by age 35, with lower-income students disproportionately affected. 

Complementary evidence from an urban public college in New York City shows similar patterns of disruption. Using an online survey administered in summer 2020, @rodriguez-planas_hitting_2020 reported that between 14% and 34% of students considered dropping at least one course during Spring 2020, 30% revised their graduation plans, and freshman fall retention fell sharply. The pandemic also led to widespread job loss and earnings reductions; Pell Grant recipients were more likely than non-recipients to lose employment or income and to experience basic-needs insecurity, and first-generation and transfer students were hit particularly hard. These studies underscore the magnitude and heterogeneity of pandemic-related shocks, but they rely on self-reported outcomes rather than standardized measures of learning.

Because the primary educational shock of COVID-19 was a rapid move to remote instruction, this work naturally connects to the broader literature on online and hybrid learning. Reviews of pre-pandemic evidence document a range of instructional models—fully online, software-assisted, and hybrid formats—and generally mixed effects on achievement [@escueta_education_2017]. Randomized and quasi-experimental studies often find that students in online sections perform worse than those in face-to-face courses [@joyce_does_2015; @alpert_randomized_2016]. Other work shows that online instruction tends to exacerbate existing achievement gaps, with lower-performing students faring particularly poorly [@bettinger_virtual_2017; @cacault_distance_2021]. Consistent with this pattern, multiple analyses report lower completion rates, grades, and persistence in online courses relative to traditional formats [@jaggars_how_2016; @xu_promises_2019].

A growing set of studies exploits the pandemic itself as an exogenous shock to learning modality. @altindag_is_2021 use administrative data from a public university and a fixed-effects framework to estimate the effect of switching from face-to-face to online instruction during COVID-19. They find that online courses are associated with lower grades and a higher likelihood of withdrawal, while greater exposure to in-person instruction is linked to higher on-time graduation rates and graduation GPAs, with modality gaps narrowing somewhat in subsequent post-pandemic semesters. In a randomized experiment at West Point, @kofoed_zooming_2021 assigned students in a required introductory economics course to either online or in-person sections in Fall 2020 and found that online students earned substantially lower final grades, with especially large effects for academically at-risk students and survey evidence of weaker engagement and sense of connection. Using Virginia community college data, @bird_negative_2022 implement a difference-in-differences strategy with instructor and student fixed effects and estimate modest but statistically significant reductions in course completion following the rapid shift online; faculty experience with online teaching does not fully offset these negative effects, and long-run impacts appear limited.

Other work highlights that the net effect of the pandemic on measured achievement can be positive when institutional and behavioral responses are favorable. For example, @bonacini_unraveling_2023 analyze administrative records for roughly 36,000 students taking about 400,000 exams at an Italian university between 2018 and 2021. They estimate both the overall impact of the pandemic on exam performance and the specific contribution of the transition to remote instruction using a difference-in-differences design. Their results suggest that average exam scores increased during the pandemic, but that the abrupt move to online teaching exerted a separate negative effect on performance, illustrating the importance of separating general pandemic effects from modality-specific channels.

Taken together, survey-based studies consistently document substantial negative impacts of COVID-19 on students’ academic plans, wellbeing, and perceived performance [@aucejo_impact_2020; @rodriguez-planas_hitting_2020; @jaeger_global_2021]. In contrast, studies using administrative outcomes often find smaller or mixed effects on grades, course completion, and credits earned, especially in the immediate aftermath of the shift online [@bird_negative_2022; @bonacini_unraveling_2023]. One explanation is that many institutions adopted temporary policies to cushion students from the shock—such as expanded pass/fail options, flexible withdrawal deadlines, and more lenient grading—at the same time instructors adjusted assessment practices for remote delivery. These changes complicate the interpretation of course GPA, semester GPA, or completion as measures of true learning. For example, @rodriguez-planas_covid-19_2022 show that lower-income students at an urban public college were much more likely to take advantage of a flexible grading policy, which prevented observable GPA declines for some groups despite underlying academic struggles.

This literature provides important insights into how the pandemic disrupted higher education, but several gaps remain. First, heavy reliance on self-reported survey outcomes limits our ability to quantify actual learning loss. Second, even when studies use administrative measures, the focus on course completion or GPAs is problematic in settings where grading standards and withdrawal options changed abruptly. Third, few studies explicitly address potential shifts in exam difficulty or assessment content during the transition to remote instruction. In this paper, I address these limitations in two ways. I use standardized common final exams in an introductory microeconomics course to track performance before and during the pandemic, avoiding variation in instructor-specific grading standards. I then exploit a novel question-level dataset that links 35 pairs of identical or nearly identical items across pre-pandemic and pandemic-era finals, allowing me to measure changes in the probability of answering the same content correctly over time. This approach yields more credible estimates of pandemic-related learning loss and clarifies the roles of grading policy, instructional modality, and student heterogeneity in shaping observed outcomes.
...
The data for this study are drawn from two primary sources covering the academic years 2019 through 2022. The first source records student performance on common departmental final examinations for an *introductory microeconomics* course (ECO 1001) at a large public university in New York City. This course is offered every semester, taught by multiple instructors, and at least 700 students enroll annually.
...
To exploit the granularity of the data, I also construct a second measure based on item-level performance. Because the final exams are departmental, I am able to match identical or nearly identical questions appearing in exams administered both pre- and post-pandemic onset. While the department utilizes two versions of the exam to deter cheating (differing only in question order), the content remains constant. I manually identified and matched 35 unique pairs of questions across the pre-pandemic and pandemic periods.^[35 unique pairs of question are matched from before and after pandemic common exams. The questions are provided in a separate document.] This allows for the construction of a binary outcome variable, *correct*, which takes a value of 1 if a student answered the matched question correctly and 0 otherwise.

The second data source consists of institutional administrative records for all students enrolled in the *introductory microeconomics* course (ECO 1001) during the relevant semesters. This dataset includes a rich set of covariates, including gender, race, age, student's part-time status, and class standing (freshman through senior).
...
Finally, Table 1 reports the baseline cumulative GPA, which serves as a critical control for student ability. As the data section details, I impute missing baseline GPA values using the end-of-semester GPA or, if both are unavailable, the semester-specific mean GPA.
...
A similar pattern emerges when performance is measured using matched-question outcomes. The top-right panel (matched questions: low vs. high GPA) indicates a sharp drop in the probability that low-GPA students answer a matched question correctly in the early pandemic period, with little evidence of convergence back to pre-pandemic differentials through Spring 2022. By contrast, the bottom-right panel (matched questions: online vs. hybrid) suggests that the initial decline associated with the shift to online instruction attenuates over time, with estimates moving back toward pre-pandemic levels by the later period. 

## Effects Due to Heterogenity in Difficulty of Questions

The preceding results indicate that pandemic-era learning losses are concentrated among academically vulnerable students and vary by instructional modality. I next examine whether these patterns differ systematically by item difficulty. Because all enrolled students take the common final exam, and exam items were pre-classified by instructors as either *easy* or *hard*, I can stratify the matched-question analysis by difficulty while holding item content constant. Importantly, I retain the original (pre-pandemic) difficulty designation for each matched item—an item is treated as *hard* (or *easy*) if it was labeled as such in the pre-pandemic exams—thereby minimizing concerns that observed performance changes reflect shifts in exam composition rather than changes in mastery.

Table 5 reports the resulting estimates. Panel A compares low- and high-GPA students. On easy questions, low-GPA students perform worse on average (about 9-10 percentage points), but the post-pandemic interaction is small and statistically indistinguishable from zero. On hard questions, low-GPA students are substantially less likely to answer correctly than high-GPA students (a 14.1 percentage point gap in Column 3). Moreover, this disparity widens in the post-pandemic period: the interaction term in Column 4 indicates an additional 3.7 percentage point decline for low-GPA students on hard items relative to high-GPA students ($p < 0.01$), suggesting that the additional pandemic-era decline for low-GPA students is concentrated in more difficult content.
...
Panel B conducts an analogous analysis comparing online versus hybrid instruction. Students enrolled in online sections perform worse on both easy and hard items in the pre-pandemic baseline period (Columns 1 and 3). However, following the pandemic-induced shift to remote learning, the interaction term for online enrollment is positive for hard questions (Column 4: $0.100$, $p < 0.01$), indicating a relative improvement in hard-item performance for students associated with the online modality during the post-pandemic period. By contrast, the corresponding interaction for easy questions is not statistically significant (Column 2), implying that any relative gains are concentrated among hard items. Overall, stratifying by difficulty suggests that the pandemic disproportionately reduced performance on harder material for low-GPA students, while the modality-related dynamics differ by outcome type and are most pronounced for hard questions.

# Conclusion

This study examines the impact of the COVID-19 pandemic on undergraduate academic performance by analyzing common final examination results in an introductory microeconomics course at a large public university in New York City. I advance the literature on pandemic-era learning by providing more reliable estimates of college-level learning loss than those currently available. A key contribution is my use of two outcome measures that avoid the confounding effects of flexible grading policies and other institutional accommodations commonly cited in prior research. First, I analyze aggregate scores on common departmental final exams administered from 2019 through 2022 (excluding Spring 2020 due to data unavailability). Second, recognizing that exam difficulty may have shifted during the pandemic, I construct a dataset of 35 matched question pairs from these common finals, enabling me to measure changes in the probability of answering nearly identical items before and during the pandemic while holding content and difficulty constant.

The results reveal consistent evidence of pandemic-induced learning loss. Aggregate exam scores declined by approximately 1.2 points during the pandemic period, though this estimate is not statistically significant. However, the probability of correctly answering a matched question fell by 1.9 percentage points, a decline that is both statistically and substantively meaningful. Importantly, this item-level measure is unaffected by changes in grading leniency, providing clearer evidence of reduced mastery. The magnitude of learning loss was greatest in Fall 2020, attenuated somewhat through Fall 2021, and then stabilized, suggesting partial—but incomplete—adaptation over time.

The distributional consequences of the pandemic are stark. Students with below-median GPAs experienced an additional 3.3 percentage point reduction in the probability of answering matched questions correctly relative to their high-GPA peers during the pandemic. This differential persists even after controlling for a comprehensive set of demographic and academic characteristics and including instructor and session fixed effects. When aggregate exam scores are used as the outcome, low-GPA students scored 3.2 points lower than high-GPA students during the pandemic. Longitudinal analysis reveals that while this gap narrowed slightly over time, it remained elevated relative to pre-pandemic levels through Spring 2022. Quartile-based heterogeneity analysis reinforces this pattern: students in the bottom quartile of the GPA distribution were 4.1 percentage points less likely to answer matched questions correctly during the pandemic compared to top-quartile students. Collectively, these findings provide robust evidence that the pandemic exacerbated pre-existing inequalities in learning outcomes.

I also investigate an important mechanism through which the pandemic affected performance: the abrupt shift to remote instruction. The difference-in-differences estimates indicate that the forced transition from hybrid to fully online learning reduced exam scores by approximately 5.3 points. Paradoxically, the matched-question analysis yields a positive interaction term: students in online sections showed a 6.0 percentage point increase in the probability of correctly answering matched items relative to hybrid students after the onset of the pandemic. Temporal analysis suggests that the initial disruption from the modality shift attenuated over subsequent semesters, with performance gradually returning toward pre-pandemic levels. This divergence between aggregate and item-level outcomes underscores the importance of measurement choice in assessing pandemic impacts.

To further probe the nature of learning loss, I stratify the matched-question analysis by item difficulty. The results indicate that pandemic-era declines for low-GPA students are concentrated in harder content: their probability of answering difficult matched questions correctly fell by an additional 3.7 percentage points relative to high-GPA students, while no significant differential emerges for easier items. Conversely, students in online sections performed 10.0 percentage points better on hard questions after the shift to remote learning, with no significant difference on easy questions. These patterns suggest that the mechanisms linking the pandemic to performance vary by content complexity and instructional modality.

Overall, my findings align directionally with the broader literature documenting negative pandemic effects on student outcomes, but they provide more precise estimates by addressing biases introduced by flexible grading policies. The matched-question design isolates changes in actual mastery from changes in evaluation standards. I acknowledge, however, that these estimates may not fully account for potential increases in academic misconduct, particularly during the early months of remote instruction when proctoring and assessment security were limited.

The implications of these findings extend beyond the immediate pandemic period. While course and cumulative GPAs remained stable or even increased during the pandemic—suggesting strong performance—survey evidence consistently documents substantial student hardship and perceived learning difficulties. My results reconcile this apparent contradiction: standardized, content-matched assessments reveal meaningful learning loss that grade inflation obscures. For policymakers and institutional leaders, these findings underscore the risks of abrupt transitions to remote instruction during crises and highlight the disproportionate burden such disruptions impose on academically vulnerable students. Future decisions to shift instructional modalities under duress should weigh these equity and learning consequences carefully.
