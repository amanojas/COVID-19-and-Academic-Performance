...
f12 <- read_rds(sum_stats_url) |>
  select(-id, -`SAT verbal`, -`SAT math`, -correct, -`Native Language English?`) |>    ## Not using these variables in the analyses due to high number of missing values. So, it is not useful to show them in the table.
...
datasummary_balance(
  ...
  footnote(
    ...
    escape = TRUE, threeparttable = TRUE, footnote_as_chunk = TRUE
  )
